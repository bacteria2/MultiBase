...
-- ----------------------------
DROP TABLE IF EXISTS `multi_demo_user_resource_permit`;
CREATE TABLE `multi_demo_user_resource_permit` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增长ID',
...
-- ----------------------------
DROP TABLE IF EXISTS `multi_demo_user_resource_deny`;
CREATE TABLE `multi_demo_user_resource_deny` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增长ID',
  `user_id` varchar(60) NOT NULL DEFAULT ''  COMMENT '用户ID',
  `resource_id` varchar(60) NOT NULL DEFAULT '' COMMENT'资源ID',
  `creator` varchar(60) NULL DEFAULT '' COMMENT '创建者',
